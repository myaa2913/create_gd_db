...
CREATE TABLE employerid_siteid_entid (
    employerid numeric,
    year numeric,
    siteid numeric,
    ent_id text
...
\copy employerid_siteid_entid FROM '~/projects/def-mcorrito/mcorrito/create_gd_db/cult_measure_upload/orgid_siteid_entid_map.csv' DELIMITER ',' quote '"' CSV HEADER;
